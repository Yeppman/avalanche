...
class/* */ extends _react.Component {
  constructor(...args) {
    super(...args);
    this.context = void 0;
  }
  ...
  render() {
    ...
    let children = this.props.children; // show a warning if/* */ contains <title> (only in development)
    ...
    let hasCanonicalRel = false; // show warning and remove conflicting amp/* */ tags
   ...
   /* */ = _react.default.Children.map(head || [], child => {
    ...
    }))), children,/* */, /*#__PURE__*/_react.default.createElement("meta", {
